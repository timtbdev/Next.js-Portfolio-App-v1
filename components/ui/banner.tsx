  ...
  return (
    <div className="mt-6 flex justify-center">
      <a
        ...
        className="group relative inline-flex items-center gap-x-1.5 rounded-full border-none bg-transparent p-2 shadow-sm ring-1 ring-gray-300 hover:bg-gray-50 hover:ring-blue-500 dark:ring-gray-500 dark:hover:bg-gray-900 dark:hover:ring-sky-500"
